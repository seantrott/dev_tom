...
df_coef %>%
  ...
  coord_flip() +
  scale_x_discrete(labels = c("conditionTrue Belief" = "Condition: True Belief",
                               "z_tokensseen" = "z(# Tokens Seen)",
                               "z_nparams" = "z(# Parameters)",
                               "knowledge_cueImplicit" = "Knowledge Cue: Implicit",
                              "z_nparams:z_tokensseen" = "z(# Parameters):z(# Tokens Seen)")) +
  labs(
